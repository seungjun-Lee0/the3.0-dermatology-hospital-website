    ...
    <div class="comm_wrap2">
        ...
        <div class="flex">
            <div class="adminModal">
                <form id="adminDataCureTFrm" name="adminDataCureTFrm" role="form" enctype="multipart/form-data">
                <div class="adminModalContent" style="margin: 1.5% 0;">
                    <div class="adminModalTitle">T.E.N.S</div>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                5<input type="radio" name="tTime" id="t1" value="5" class="radioBtnRight">
                            </td>
                            <td>
                                10<input type="radio" name="tTime" id="t2" value="10" class="radioBtnRight">
                            </td>
                            <td>
                                15<input type="radio" name="tTime" id="t3" value="15" class="radioBtnRight">
                            </td>
                            <td>
                                20<input type="radio" name="tTime" id="t4" value="20" class="radioBtnRight">
                            </td>
                            <td>
                                30<input type="radio" name="tTime" id="t5" value="30" class="radioBtnRight">
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center">전압</td>
                            <td colspan="5">
                                <input style="height: 20px; width: 50px;" type="text" maxlength="4" name="tVoltage" id="tVoltage" class="">&nbsp;V
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center">주파수</td>
                            <td colspan="5">
                                <input style="height: 20px; width: 50px;" type="text" maxlength="4" name="tHz" id="tHz" class="">&nbsp;HZ
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    <div class="adminButton_pos">
                        <div class="btnArea M b_center">
                            <a id="adminDataCureTBtn" class="close black_s" >저장</a>
                        </div>
                    </div>
                </div>
                </form>
