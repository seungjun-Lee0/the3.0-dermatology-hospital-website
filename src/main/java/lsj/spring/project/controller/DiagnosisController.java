...
public class DiagnosisController {
    ...
    File rawImagePath = new File("/opt/tomcat/acne_detect/dist/acne_detect/test");
    ...
    private String resultFile = "/opt/tomcat/acne_detect/dist/acne_detect/result_file.csv";
